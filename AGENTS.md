...
- Links: wiki-style `[[...]]`, internal link resolution, backlinks, TOC. Local media (`img@src`, `video`/`audio`/`source@src`, PDF `object@data`) go through `AssetRef` (published path, missing-asset errors), not page-link title-walk.
