...
final class SiteSpec extends AnyFunSuite, BeforeAndAfterAll:
  ...
  test("store index lists includes in document order; extras error; hops are not pages") {
    ...
    val appleHref: Int = listing.indexOf("""href="/stores/item/apple.html"""")
    ...
    assert(!postContent.contains("item:"), postContent)
    ...
    assert(!listing.contains("/stores/item/ghost"), listing)
    ...
    assert(zebra.contains("item zebra"), zebra)
    assert(zebra.contains("zebra body"), zebra)
    assert(zebra.contains("""href="/stores/item/apple.html""""), zebra)
    assert(!zebra.contains("""href="/stores/item/index.html""""), zebra)
    val apple: String = html("stores/item/apple.html")
    assert(apple.contains("apple body"), apple)
    assert(apple.contains("""href="/stores/item/zebra.html""""), apple)
    val errors: String = html("errors.html")
