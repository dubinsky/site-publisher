...
It supports HTML, Markdown, and AsciiDoc.
...
Handle bibliography in a markup-independent way.

MarkDown: https://pandoc.org/MANUAL.html#citations

Is there some Java library for citation formatting?
