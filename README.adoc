...
Optional `facsimiles-url` is the base URL of a facsimile site (JPEG bucket; trailing slash as in the collector `tei@facsimilesUrl`). Omitted means none. TEI facsimile viewer pages are not generated yet.
