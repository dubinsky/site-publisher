...
Review all Grok's code and clean it up/simplify...
...
Support glossary in all markups, not just AsciiDoc.

MarkDown:

- https://github.com/vsch/flexmark-java/wiki/Extensions#definition-lists
- https://github.com/vsch/flexmark-java/wiki/Definition-List-Extension
